    ...
    return (
        <div className="root-left-page">
            <div className="img-info">
                ...
                alt="foto" className="rounded-circle" width="50%" height="auto" />
            </div>
            ...
            <div className="navigasi-info">
                Navigasi
            </div>
            {/* <Link to={url} className="link-route">
                Dashboard
            </Link> */}
            <Link to={`${url}/users`} className="link-route">
                Master User
            </Link>
            <Link to={`${url}/supplier`} className="link-route">
                Master Supplier
            </Link>
            <Link to={`${url}/product`} className="link-route">
                Master Product
            </Link>
            <Link to={`${url}/transaksi`} className="link-route">
                Transaksi
            </Link>
            <Link to={`${url}/report`} className="link-route">
                Report
            </Link>
        </div>
    );
